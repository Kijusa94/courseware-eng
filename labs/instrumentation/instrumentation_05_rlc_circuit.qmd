---
title: "Práctica de Circuitos RLC"
description: "Análisis de la respuesta transitoria de los circuitos RC, RL y RLC en corriente continua mediante el simulador Falstad."
---
...
### Capacitor
Un capacitor es un componente electrónico pasivo que almacena energía en un campo eléctrico. Se compone de dos placas conductoras separadas por un material aislante o dieléctrico. Su capacidad para almacenar carga es proporcional al voltaje a través de sus terminales, siendo la constante de proporcionalidad la capacitancia $C$ medida en Faradios.
$$
C = \frac{Q}{V}
$$
...
- **CIRCUITO RC:** La carga y descarga de un capacitor en un circuito RC siguen una curva exponencial. La velocidad de este proceso está determinada por la constante de tiempo que se calcula como $ \tau = R C $. Después de un periodo de $ 5 \tau $ el capacitor se considera completamente cargado o descargado.
